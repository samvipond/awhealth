          ...
          <div class="top-menu-container">
            <?php
              wp_nav_menu(array(
                ...
                "menu_class" => "sf-menu header-right absolute-left"
              ));
            ?>
            <div class='booking-button menu-item'>
            <a href='<?php echo esc_url(get_home_url()); ?>/make-a-booking/'>SCHEDULE ONLINE</a>
            </div>
          </div>
          <!-- End Extra Top Menu -->
          </div>
